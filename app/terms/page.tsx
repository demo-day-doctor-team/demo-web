      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-gray prose-lg max-w-none">
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제1조 (목적)</h2>
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제2조 (용어의 정의)</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              본 약관에서 사용하는 주요 용어의 정의는 다음과 같습니다.
            </p>
            <ul className="list-disc list-inside space-y-3 text-gray-700">
              <li><strong className="text-[#2F9A88]">"서비스"</strong>란 회사가 제공하는 액체생검 포함 방문형 건강검진 및 관련 건강관리 서비스를 의미합니다.</li>
              <li><strong className="text-[#2F9A88]">"이용자"</strong>란 본 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.</li>
              <li><strong className="text-[#2F9A88]">"회원"</strong>이란 회사와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여받은 이용자를 말합니다.</li>
              <li><strong className="text-[#2F9A88]">"아이디(ID)"</strong>란 회원의 식별과 서비스 이용을 위하여 회원이 설정하고 회사가 승인하는 문자와 숫자의 조합을 의미합니다.</li>
              <li><strong className="text-[#2F9A88]">"비밀번호"</strong>란 회원이 부여받은 아이디와 일치된 회원임을 확인하고 회원 자신의 비밀을 보호하기 위하여 회원이 정한 문자와 숫자의 조합을 의미합니다.</li>
            </ul>
          </section>

          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제3조 (약관의 효력 및 변경)</h2>
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제4조 (서비스의 제공)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제5조 (회원가입)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제6조 (회원정보의 변경)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제7조 (회원 탈퇴 및 자격 상실)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제8조 (회원에 대한 통지)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제9조 (회사의 의무)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제10조 (회원의 의무)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제11조 (서비스의 중단)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제12조 (면책조항)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제13조 (분쟁의 해결)</h2>
            <div className="space-y-4 text-gray-700">
          ...
          <section className="mb-12 bg-gray-50 p-8 rounded-xl border border-gray-200">
            <h2 className="text-2xl font-bold mb-4 text-[#2F9A88]">제14조 (재판권 및 준거법)</h2>
            <div className="space-y-4 text-gray-700">
