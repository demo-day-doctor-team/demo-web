      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">1. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">2. 수집하는 개인정보 항목</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              회사는 서비스 제공을 위해 필요한 최소한의 개인정보를 수집합니다.
            </p>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#8DD4C5]">필수 항목</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-300">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#8DD4C5]">선택 항목</h3>
                <ul className="list-disc list-inside space-y-2 text-gray-300">
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">3. 개인정보의 보유 및 이용기간</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">4. 개인정보의 제3자 제공</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">5. 개인정보의 파기</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
            </p>
            <div className="space-y-4 text-gray-300">
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#8DD4C5]">파기 절차</h3>
                <p>이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다.</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[#8DD4C5]">파기 방법</h3>
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">6. 정보주체의 권리·의무 및 행사방법</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">7. 개인정보 보호책임자</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
              회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
            </p>
            <div className="bg-gray-800/50 p-6 rounded-lg space-y-2 text-gray-300">
              <p><strong className="text-[#8DD4C5]">개인정보 보호책임자</strong></p>
          ...
          <section className="mb-12 bg-gray-900/50 p-8 rounded-xl border border-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#4BBEAC]">8. 개인정보 처리방침 변경</h2>
