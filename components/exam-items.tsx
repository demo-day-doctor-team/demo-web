...
export default function ExamItems() {
  ...
  const examItems = [
    ...
    },
    {
      ...
      features: [
        "혈액 일반 검사 (WBC, RBC, Hemoglobin, Hematocrit, MCV, MCH, MCHC, Platelets 등)",
        "영양 관련 검사 (T.protein, Albumin)",
        "간·담관질환 검사 (T.Bilirubin, AST, ALT, Alk.Phosphatase, r-GTP)",
        "간염 검사 (HBsAg, HBsAb)",
        "신장질환 검사 (BUN, Creatinine)",
        "지질관련 검사 (T.Cholesterol, HDL, LDL, Triglyceride)",
        "당뇨관련 검사 (Glucose, HbA1c)",
        "전해질 및 대사관련 검사 (Uric acid)",
        "빈혈 검사 (Fe, TIBC, Ferritin)",
        "갑상선질환 검사 (Free T4, TSH)",
        "비타민 검사 (25-OH Vitamin D)",
      ],
    },
  ]
