...
const EMAILJS_CONFIG = {
    ...
    recipientEmail:
        process.env.NEXT_PUBLIC_RECIPIENT_EMAIL || "yeobg1022@gmail.com",
};
...
export default function ConsultationForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.status === 200 || result.text === "OK") {
                ...
                setAgreePrivacyCollection(false);
            } else {
                setSubmitStatus("error");
    ...
    return (
        <section
            ...
            className="py-20 sm:py-24 md:py-28 lg:py-32 px-4 sm:px-6 md:px-8 relative bg-white"
        >
            <div className="container mx-auto relative z-10 max-w-5xl">
                <div className="text-center mb-14 sm:mb-16 md:mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#E8F5F2] to-[#F0F9F7] rounded-full border-2 border-[#2F9A88]/20 mb-5 sm:mb-6 shadow-sm">
                        <span className="text-xs font-semibold text-[#2F9A88] uppercase tracking-wider">
                            검진 예약
                        </span>
                    </div>
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-gray-700 font-normal leading-relaxed px-4">
                        원하는 날짜와 장소를 선택하여 간편하게 예약하세요
                    </p>
                </div>
                        ...
                        <CardContent className="p-6 sm:p-8 md:p-10 lg:p-12">
                            ...
                            >
                                        ...
                                        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                            <div className="flex items-center gap-2">
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={(
                                                        ...
                                                        setAgreePrivacyCollection(
                                                            checked === true
                                                        )
                                                    }
                                                    className="border-gray-400 data-[state=checked]:border-[#2F9A88] data-[state=checked]:bg-[#2F9A88]"
                                                    disabled={isSubmitting}
                                                />
                                                <Label
                                            ...
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <button
                                                        type="button"
                                                        className="text-xs font-semibold text-[#2F9A88] underline underline-offset-4 hover:text-[#1F7A6B]"
                                                    >
                                                        전문 보기
                                                    </button>
                                                </DialogTrigger>
                                ...
                                <p className="text-sm text-gray-500 text-center mt-4">
                                    * 입력하신 정보는 예약 및 검진 진행
                                    목적으로만 사용되며, 안전하게 보호됩니다.
                                    <br />* 예약 신청 후 담당자가 연락을 드려
                                    최종 일정을 확정해드립니다.
                                </p>
                            </form>
                        </CardContent>
